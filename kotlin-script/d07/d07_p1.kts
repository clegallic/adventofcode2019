...
fun thruster(intCodeProgram: IntArray, combination: IntArray): Int{
    var result = 0
    var lastOutput = 0
    for(i in combination){
        var input = mutableListOf<Int>(i,lastOutput)
        lastOutput = compute(intCodeProgram, input)
        result = lastOutput
    }
    return result
}
                        ...
                        if(i4 != i1 && i4 != i2 && i4 != i3){
                            for (i5 in 0..4){
                                if(i5 != i1 && i5 != i2 && i5 != i3 && i5 != i4){
                                    var total = thruster(intCodeProgram, intArrayOf(i1, i2, i3, i4, i5))
                                    if(total > highest) {
                                        highest = total
